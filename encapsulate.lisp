...
(def-stream-method input-stream-p ((stream
					   standard-encapsulating-stream)))

(def-stream-method output-stream-p ((stream
					    standard-encapsulating-stream)))

(def-stream-method stream-element-type ((stream
						standard-encapsulating-stream)))

(def-stream-method open-stream-p ((stream
					  standard-encapsulating-stream)))

(def-stream-method close ((stream standard-encapsulating-stream)
				 &key abort))

(def-stream-method stream-pathname ((stream
					    standard-encapsulating-stream)))

(def-stream-method stream-truename ((stream
					    standard-encapsulating-stream)))

(def-stream-method stream-read-char ((stream
					     standard-encapsulating-stream)))

(def-stream-method stream-unread-char ((stream
					       standard-encapsulating-stream)
					      character))
...
(def-stream-method stream-peek-char ((stream
					     standard-encapsulating-stream)))

(def-stream-method stream-listen ((stream
					  standard-encapsulating-stream)))

(def-stream-method stream-read-line ((stream
					     standard-encapsulating-stream)))

(def-stream-method stream-clear-input ((stream
					       standard-encapsulating-stream)))
...
(def-stream-method stream-line-column ((stream
					       standard-encapsulating-stream)))
...
(def-stream-method stream-terpri ((stream
					  standard-encapsulating-stream)))

(def-stream-method stream-fresh-line ((stream
					      standard-encapsulating-stream)))
...
(def-stream-method stream-read-byte ((stream
					     standard-encapsulating-stream)))
