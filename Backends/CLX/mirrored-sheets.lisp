...
(defmethod (setf clim:sheet-transformation) (region (sheet clx-mirrored-sheet-mixin))
  (declare (ignore region))
  (let ((old-native-transformation (%%sheet-native-transformation sheet)))
    (call-next-method)
    ;;(%%set-sheet-native-transformation old-native-transformation sheet)
...
(defmethod sheet-mirror-region ((sheet clx-mirrored-sheet-mixin))
  (cond
...
(defmethod sheet-mirror-region ((sheet clx-graft))
  (make-rectangle* 0 0 #x10000 #x10000))
...
(defmethod effective-mirror-region ((sheet clx-mirrored-sheet-mixin))
