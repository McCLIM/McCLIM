...
;;; pointer events
;;;
(defmethod climi::distribute-event :before ((port clxv3-port) (event pointer-button-press-event))
  (setf (port-pointer-pressed-sheet port) (port-pointer-sheet port)))

(defmethod climi::distribute-event :after ((port clxv3-port) (event pointer-button-release-event))
  (setf (port-pointer-pressed-sheet port) nil))

(defmethod climi::distribute-event :around ((port clxv3-port) (event pointer-event))
...
(defmethod climi::distribute-event ((port clxv3-port) (event pointer-event))
...
(defmethod climi::distribute-event ((port clxv3-port) event)
  (cond
