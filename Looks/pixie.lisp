...
#|
    (multiple-value-bind (rx ry) (values (/ (- y2 y1) 2) (/ (- x2 x1) 2))
      (draw-ellipse* pane cx cy 0 ry rx 0
                     :start-angle (* 1/4 pi)
                     :end-angle (* 5/4 pi)
                     :ink *3d-dark-color*)
      (draw-ellipse* pane cx cy 0 ry rx 0
                     ...
                     :end-angle (* 9/4 pi)
                     :ink *3d-light-color*)
      (draw-ellipse* pane cx cy 0 (max 1 (- ry 2)) (max 1 (- rx 2)) 0
                     :ink (effective-gadget-input-area-color pane))
      (when value
        (draw-ellipse* pane cx cy 0 (max 1 (- ry 4)) (max 1 (- rx 4)) 0
...
(defclass pixie-push-button-pane  (pixie-gadget push-button-pane) ())
