...
The easiest way to try this is to use the great \emph{Quicklisp}
library manager. Assuming that this is already setup, trying out the
...
Alternatively, for the more courageous, \texttt{asdf} works well starting from
the McCLIM source code directory. 
