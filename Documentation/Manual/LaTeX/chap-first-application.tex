...
\item
  ...
  such as layout panes such as \pane{hbox}, \pane{vbox} to arrange
  other panes horizontally or vertically, etc.
\item
  \emph{gadgets} correspond to what other toolkits call
  \emph{widgets}.  Frequently used CLIM gadgets are \gadget{button}s,
  \gadget{slider}s, etc.
\end{itemize}
...
class that inherits from the class \class{application-frame}, and that
