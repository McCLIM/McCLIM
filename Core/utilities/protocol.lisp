...
(declfun parse-text-style* (port style))
(declfun normalize-font-size (port size))
...
(defgeneric device-event-native-graft-x (instance))
(defgeneric device-event-native-graft-y (instance))
...
(defgeneric pointer-event-native-graft-x (instance))
(defgeneric pointer-event-native-graft-y (instance))
...
(defgeneric window-configuration-event-x (instance))
(defgeneric window-configuration-event-y (instance))
(defgeneric window-configuration-event-width (instance))
(defgeneric window-configuration-event-height (instance))
