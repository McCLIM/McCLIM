...
(declaim (inline opticl-image-data-get-pixel)
	 (ftype (function (opticl-image-data fixnum fixnum) (values octet octet octet octet)) opticl-image-data-get-pixel))
...
(declaim (inline opticl-image-data-set-pixel)
	 (ftype (function (opticl-image-data fixnum fixnum octet octet octet octet) t) opticl-image-data-set-pixel))
...
(defmethod copy-image ((image opticl-image)
  ...
  (let ((data-image (image-data image))
    ...
    (declare (type opticl-image-data data-image src-data-image))
    (make-copy-image-function
     (eql image src-image)
     src-dx src-dy
     (opticl-image-data-get-pixel src-data-image (+ src-dx i) (+ src-dy j))
