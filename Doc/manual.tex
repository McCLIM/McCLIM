...
such output with an arbitrary Common Lisp object a presentation type.
The presentation type is not necessarily related to the idea the
...
\emph{arguments}.  Arguments of presentation types are typically used
to restrict the type.  For instance, the presentation type
\texttt{integer} takes as arguments the low and the high values of an
interval.  Such arguments allow the application to restrict objects
...
In this application, we have two main pains, an application pane and
