...
called the ``user coordinate system,'' and coordinate values expressed
in the user coordinate system are known as ``user coordinates.''
...
CLIM uses its own transformations to translate coordinates from a
