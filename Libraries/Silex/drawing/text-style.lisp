...
(eval-when (:compile-toplevel :load-toplevel :execute)
  ...
  (define-constant +smaller-sizes+ '(:huge :very-large :large :normal
                                     :small :very-small :tiny :tiny)
      :test #'equal)

  (define-constant +larger-sizes+ '(:tiny :very-small :small :normal
  ...
  (define-constant +font-sizes+
      '(:normal 14 :tiny 8 :very-small 10 :small 12 :large 18 :very-large 20 :huge 24)
      :test #'equal :documentation "Mapping between keyword and a font size."))
